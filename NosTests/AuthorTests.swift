...
final class AuthorTests: CoreDataTestCase {
    ...
    func testMarkdownIdentifier() throws {
        let context = persistenceController.viewContext
        let key = RawNostrID.random
        ...
        XCTAssertEqual(author.markdownIdentifier, truncatedKey)
        author.nip05 = nip05
        XCTAssertEqual(author.markdownIdentifier, "[me@nip05.com](https://njump.me/\(publicKey.npub))")
    }
}
