...
let coarseLanguage = ReportCategory(name: .moderation.coarseLanguage, code: "CL", nip56Code: .profanity)
let likelyToCauseHarm = ReportCategory(name: .moderation.likelyToCauseHarm, code: "HC", nip56Code: .other)
let intoleranceAndHate = ReportCategory(name: .moderation.intoleranceAndHate, code: "IH", nip56Code: .other)
let illegal = ReportCategory(
...
let pornography = ReportCategory(
...
let spam = ReportCategory(name: .moderation.spam, code: "SP", nip56Code: .spam)
let violence = ReportCategory(
...
let other = ReportCategory(name: .moderation.other, code: "NA", nip56Code: .other)
