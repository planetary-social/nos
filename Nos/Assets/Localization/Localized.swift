...
enum Localized: String, Localizable, CaseIterable {
    ...
    case userReportedByOne = "This user has been reported by **{{ one }}** for {{ reason }}."
    case userReportedByOneAndMore = "This user has been reported by **{{ one }}** and **{{ count }} others** for {{ reason }}."
    case noteReportedByOne = "This note has been reported by **{{ one }}** for {{ reason }}."
    case noteReportedByOneAndMore = "This note has been reported by **{{ one }}** and **{{ count }} others** for {{ reason }}."
    ...
    Nos is committed to fostering safe and respectful community. To achieve this we display content warnings when someone you follow reports a note. You can change this in the settings menu.
    """
    ...
    case unsSuccessDescription = "You have successfully linked your Universal Name to your Nostr profile."
